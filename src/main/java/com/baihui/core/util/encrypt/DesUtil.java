 ...
 * @Description:   TODO(Des加解密工具) 
 * @All rights Reserved, Designed By PCstars
 * @Copyright:  Copyright(C) 2014-2015
 * @Company:	baihui
 * @author      ziyu.zhang
 * @version     V2.0  
 * @Date        2015年10月8日 下午6:05:32 
 */
public class DesUtil {
	/** 字符串默认键值 */
	private static String strDefaultKey = "key";
	...
	public static void main(String[] args) throws Exception {
		/*System.out.println("md5---"+EncryptUtil.md5("123456"));
		DesUtil des = new DesUtil(EncryptUtil.md5("123456"));

		try {
			String test = "123456";
			System.out.println("加密后的字符："+des.getEncString(test));
			System.out.println("解密后的字符：" + des.getDesString(des.getEncString(test)));
