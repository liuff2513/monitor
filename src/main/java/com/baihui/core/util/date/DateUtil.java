package com.baihui.core.util.date;
...
//			sb.append(" 00:00:00");
	 ...
	 * @return
	 */
	public static boolean checktimeSys(String onetime, String endtime, String format){
		if(!StringUtil.empty(onetime) && !StringUtil.empty(endtime)){
			long st = 0;
			long et = 0;
			try {
				st = new SimpleDateFormat(format).parse(onetime).getTime();
				et = new SimpleDateFormat(format).parse(endtime).getTime();
				return st>=et;
			} catch (ParseException e) {
				System.out.println(e.getMessage());
			}
	 ...
	 * @return
	 */
	public static boolean checkdaySys(String starttime, String endtime, String format){
		if(!StringUtil.empty(starttime) && !StringUtil.empty(endtime)){
			long st = 0;
			long et = 0;
			try {
				st = new SimpleDateFormat(format).parse(starttime).getTime();
				et = new SimpleDateFormat(format).parse(endtime).getTime();
				return et<st;
			} catch (ParseException e) {
				System.out.println(e.getMessage());
	...
	public static void main(String[] args) throws ParseException {
		//System.out.println(getLastMonthFirstDay("yyyy-MM-dd",0));//上个月第一天
		//System.out.println(getLastMonthEndDay("yyyy-MM-dd",0));//上个月最后一天

		/*System.out.println(getNextMonthFirstDay("yyyy-MM-dd",2));//下个月第一天
		System.out.println(getNextMonthEndDay("yyyy-MM-dd",2));//下个月最后一天

		System.out.println(getLastWeekStart(new Date(),"yyyy-MM-dd"));//上周周一
		System.out.println(getLastWeekEnd(new Date(),"yyyy-MM-dd"));//上周周末
		*/
		//System.out.println(getMondayOfThisWeek("yyyy-MM-dd"));//本周周一
		//System.out.println(getSundayOfThisWeek("yyyy-MM-dd"));//本周周末


		//System.out.println(getMondayOfNextWeek("yyyy-MM-dd"));//下周周一
		//System.out.println(getSundayOfNextWeek("yyyy-MM-dd"));//下周周末
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Date parse = sdf.parse("2012-01-02");
		System.out.println(checktimeSys("2017-05-25 09:00:00","2017-05-20 22:33:39","yyyy-MM-dd HH:mm:ss"));//下周周末
